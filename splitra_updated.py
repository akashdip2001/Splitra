...
if has_colors:
    ...
    Fore = Style = type('dummy', (), {'BRIGHT': '', 'RESET_ALL': ''})()
    def colored(text, *args, **kwargs):
        return text
    def tqdm(x, **kwargs):
        return x
    def pyfiglet_figlet_format(text):
        return text
    pyfiglet = type('dummy', (), {'figlet_format': pyfiglet_figlet_format})()

def print_banner():
    banner = pyfiglet.figlet_format("Splitra")
    print(colored(banner, "cyan"))
    print("Created by Akashdip Mahapatra".center(80, " "))
    print("-" * 80)
